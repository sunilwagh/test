 ...
 */
public final class MapRestErrorConverter implements RestErrorConverter<Map> {
    ...
    protected Map<String,Object> createMap(){return new LinkedHashMap<String, Object>()}
