 ...
 */
public final class DefaultRestErrorResolver implements RestErrorResolver,
    ...
    /**
     * 
     * @param exceptionMappingDefinitions
     *            -
     */
    public final void setExceptionMappingDefinitions(
    ...
    /**
     * 
     * @param defaultMoreInfoUrl
     *            -
     */
    public final void setDefaultMoreInfoUrl(String defaultMoreInfoUrl) {
        this.defaultMoreInfoUrl = defaultMoreInfoUrl;
    }

    /**
     * 
     * @param defaultEmptyCodeToStatus
     *            -
     */
    public final void setDefaultEmptyCodeToStatus(
            boolean defaultEmptyCodeToStatus) {
        this.defaultEmptyCodeToStatus = defaultEmptyCodeToStatus;
    }

    /**
     * 
     * @param defaultDeveloperMessage
     *            -
     */
    public final void setDefaultDeveloperMessage(String defaultDeveloperMessage) {
     ...
     */
    @Override
    public final RestError resolveError(ServletWebRequest request,
     ...
     * @return -
     */
    protected final int getStatusValue(RestError template,
     ...
     * @return -
     */
    protected final int getCode(RestError template, ServletWebRequest request,
            Exception ex) {
     ...
     * @return more info
     */
    protected final String getMoreInfoUrl(RestError template,
            ServletWebRequest request, Exception ex) {
     ...
     * @return -
     */
    protected final String getMessage(RestError template,
            ServletWebRequest request, Exception ex) {
     ...
     * @return -
     */
    protected final String getDeveloperMessage(RestError template,
            ServletWebRequest request, Exception ex) {
     ...
     * 
     */
    protected final String getMessage(String msg, ServletWebRequest webRequest,
            Exception ex) {
    ...
    private RestError getRestErrorTemplate(Exception ex) {
        ...
        if (template != null && logger.isDebugEnabled()) {
            logger.debug("Resolving to RestError template '" + template
     ...
     *            Supplied from Spring
     * @param ex
     *            exception
     * @return -
     */
    protected final int getDepth(String exceptionMapping, Exception ex) {
     ...
     * @return -
     */
    protected final Map<String, RestError> toRestErrors(Map<String, String> smap) {
     ...
     * @return -
     */
    protected final RestError toRestError(String exceptionConfig) {
